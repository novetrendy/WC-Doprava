<?php 
  class WC_Shipping_doprava_Posta extends WC_Shipping_Method{
    ...
    public function __construct($instance_id=0){
      ...
      $this->method_description='Umožněte zákazníkům vybrat si preferovanou Balíkovnu (na poště i mimo poštu).';
      
      $aktivace_posta=get_option('wc_doprava_doprava_posta');$this->enabled=$aktivace_posta;
